...
export const Conversation = ({ conversation, scrollKey, onMoveUp, onMoveDown, settings }) => {
  ...
  const isExpanded = settings.getIn(['content_warnings', 'shared_state']) ? !lastStatus.get('hidden') : expanded;
